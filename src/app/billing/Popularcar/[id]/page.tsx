...
export default async function dynamicpage(props: any) {
  ...
  const query = `*[_type == "Popularcar"]{_id, name, description, type, seatingCapacity, transmission, fuelCapacity, pricePerDay, image}`;
            ...
            <div className='bg-white lg:w-[50%] mx-auto lg:mx-0 p-4 rounded-lg h-fit order-1 lg:order-2'>
                ...
                <div className='flex justify-between mt-3'>
                    <div className='flex gap-3'>
                        <div>
                            <Image src={urlFor(car.image).url()} alt='loading' width={400} height={200} />
                        </div>
                        <div className="flex flex-col">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                                ...
                                <span className="text-gray-600">440+ Reviews</span>
                            </div>
                        </div>
                    </div>
                </div>
